...
class Cardinfo(GenesisModel):
    ...
    def set_cardtypeinfo(self):
        super.save()
        try:
            cardtype = Cardtype.objects.get(flag='Y',company=self.company, cardtype=self.cardtype)
            self.cardtypeuuid = cardtype
            self.suptype= cardtype.suptype
            self.save()
        except Exception as e:
            print('set cardtypeinfo error',self, e)
