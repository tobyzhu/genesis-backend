...
from common.constants import COMPANYID,COMPANYLIST_WITHOUT_MTCODE
...
class VipSerializer(serializers.HyperlinkedModelSerializer):
    ...
    #     print('obj',obj)
    #     if obj.company in COMPANYLIST_WITHOUT_MTCODE:
    #         mtcode=''
    #     else:
    #         mtcode=obj.mtcode
    #     return mtcode
    ...
    #     if instance.company in COMPANYLIST_WITHOUT_MTCODE:
    #         self.Meta.fields = ('uuid','company','storecode','viptype','vcode','vname','viplevel','ecode','ecode2','url','pinyin','birth','source','occupation','vdesc')
    #     else:
    #         self.Meta.fields = ('uuid','company','storecode','viptype','vcode','vname','viplevel','mtcode','ecode','ecode2','url','pinyin','birth','source','occupation','vdesc')
