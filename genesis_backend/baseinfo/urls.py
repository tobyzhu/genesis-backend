...
urlpatterns = [
    ...
    url(r'^setgoodsqty_byspec/?', views.setgoodsqty_byspec),
    url(r'^get_indexImageUrl/?', views.get_indexImageUrl),
    url(r'^get_salonlist/?', views.get_salonlist),

    url(r'^auth/login/?', auth_api.hdsysuser_login_json),
    url(r'^auth/stores/?', auth_api.hdsysuser_stores),
    url(r'^auth/permissions/?', auth_api.hdsysuser_permissions),
    url(r'^api/v1/auth/login/?', auth_api.api_v1_hdsysuser_login),
