...
class GenesisModel(models.Model):
    ...
    last_modified = models.DateTimeField(auto_created=True, auto_now_add=True, editable=False,verbose_name='最后修改时间')
    ...
    #     super(GenesisModel, self).__init__(*args, **kwargs)
    #     self._meta.get_field('company').default = self.
