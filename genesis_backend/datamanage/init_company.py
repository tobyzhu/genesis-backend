...
def init_common_base_info(company):
...
def init_baseinfo(company):
    ...
    storecode88 = Storeinfo.objects.get_or_create(company=company,storecode='88',storename='练习店',hdflag='Y')
    ...
    hdsysuser = Hdsysuser.objects.get_or_create(company=company,sys_userid='admin',sys_passwd ='',sys_userstatus=1)

    return HttpResponse("完成！", content_type="application/json")

# init_common_base_info('dieshang')
# init_baseinfo('dieshang')