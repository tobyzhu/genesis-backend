...
from datamanage.getbaseinfo_dieshang import get_ds_goods,get_ds_servieces,get_ds_empl
...
urlpatterns=[
    ...
    url(r'^get_ds_goods/', get_ds_goods),
    url(r'^get_ds_servieces/', get_ds_servieces),
    url(r'^get_ds_empl/', get_ds_empl),

    url(r'^checkvip/?', views.checkvip),
