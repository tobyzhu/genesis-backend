...
class Goodstranslog(models.Model):
    ...
    qty1 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    qty2 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    qty3 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    price1 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    price2 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    price3 = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    costprice = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    ...
    goodsuuid = models.ForeignKey(Goods,db_column='goodsuuid',blank=True,null=True,on_delete=models.SET_NULL,verbose_name='商品uuid')
    ...
    def set_goodsuuid(self):
        try:
            if self.goodsuuid == None:
                goods= Goods.object.get(company=self.company, flag='Y',gcode=self.gcode)
                self.goodsuuid = goods
                self.save()
        except Exception as e:
            print(self.company,self.gcode ,'not find in Goods!')
...
class OweReturnDetail(GenesisModel):
    owelist = models.ForeignKey(Owelist,blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='欠货单')
    goodsvaldate = models.CharField(max_length=8, blank=True, null=True)
    returnedqty = models.DecimalField(max_digits=8,decimal_places=2,default=0,blank=True,null=True,verbose_name='已还数量')
    oweqty = models.DecimalField(max_digits=8,decimal_places=2,default=0,blank=True,null=True,verbose_name='欠货数量')
    description = models.CharField(max_length=128,blank=True,null=True,verbose_name='描述')
...
class Saledtl(GenesisModel):
    ...
    price = models.DecimalField(db_column='PRICE', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    qty = models.DecimalField(db_column='QTY', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    disc = models.DecimalField(db_column='DISC', max_digits=6, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    mount = models.DecimalField(db_column='MOUNT', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    gdnote = models.CharField(db_column='GDNOTE', max_length=40, blank=True, null=True)  # Field name made lowercase.
    stbuyamount = models.DecimalField(max_digits=16, decimal_places=2, blank=True, null=True)
    batch = models.CharField(max_length=16, blank=True, null=True)
    goodsvaldate = models.CharField(max_length=8, blank=True, null=True)
...
class Salehead(GenesisModel):
    ...
    tmount = models.DecimalField(db_column='TMOUNT', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class Transdtl(GenesisModel):
    ...
    trsqty = models.DecimalField(db_column='TrsQty', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    mount = models.DecimalField(db_column='Mount', max_digits=16, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
#
# class Spaccountlog(GenesisModel):
#     id = models.BigAutoField(primary_key=True)
#     vsdate = models.CharField(max_length=8, blank=True, null=True)
#     vstime = models.CharField(max_length=8, blank=True, null=True)
#     supplierid = models.CharField(max_length=16)
#     ttype = models.CharField(max_length=8)
#     amount = models.DecimalField(max_digits=16, decimal_places=2)
#     flag = models.CharField(max_length=8, blank=True, null=True)
#     emplcode1 = models.CharField(max_length=8, blank=True, null=True)
#     emplcode2 = models.CharField(max_length=8, blank=True, null=True)
#
#     class Meta:
#         managed = False
#         db_table = 'spaccountlog'
#
