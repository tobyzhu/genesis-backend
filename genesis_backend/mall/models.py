...
class onlineShowItem(onlineCommonBaseModel):
    onlineShowType = models.ForeignKey('onlineShowType',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='在线显示分类')
    serviece = models.ForeignKey(Serviece,blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='服务项目')
    goods = models.ForeignKey(Goods,blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='商品')
...
class onlineItemImage(onlineCommonBaseModel):
    onlineshowitem = models.ForeignKey(onlineShowItem,blank=True,null=True,on_delete=models.DO_NOTHING, verbose_name='线上项目')
