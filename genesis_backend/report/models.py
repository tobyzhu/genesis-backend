...
class ReportBase(models.Model):
    ...
    storeuuid = models.ForeignKey(baseinfo.models.Storeinfo,db_column='storeuuid',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='店铺')
...
class DailyReportVip(GenesisModel):
    vipuuid = models.ForeignKey(baseinfo.models.Vip,db_column='vipuuid',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='会员')
...
class ReportItem(models.Model):
    ...
    report_uuid = models.ForeignKey('Report',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='报表')
...
class ReportItemData(models.Model):
    report_item_uuid = models.ForeignKey('ReportItem',blank=True,null=True,on_delete=models.DO_NOTHING, verbose_name='报表项次')
...
class ReportClassData(DailyReport):
    ...
    REPORT_CLASS_TYPE =  baseinfo.models.MARKETCLASS1 | baseinfo.models.MARKETCLASS2 | baseinfo.models.MARKETCLASS3 | baseinfo.models.MARKETCLASS4 \
                        | baseinfo.models.FINANCECLASS1 | baseinfo.models.FINANCECLASS2
    report_type = models.CharField(max_length=16,choices=REPORT_TYPE,blank=True,null=True,verbose_name='报表类别')
    empl = models.ForeignKey(baseinfo.models.Empl,db_column='empluuid',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='员工')
    ecode = models.CharField(max_length=16,blank=True,null=True,verbose_name='员工工号')
    vip = models.ForeignKey(baseinfo.models.Vip,db_column='vipuuid',blank=True,null=True, on_delete=models.DO_NOTHING, verbose_name='客户')
...
# class CardleftmoneyBymonth(MonthReport):
#     normal_init_leftmoney =  models.DecimalField(max_digits=16,decimal_places=2,default=0,blank=True,null=True,verbose_name='期初卡余额')
#     # normal_cardpay =
#     class Meta:
#         verbose_name='月度卡余额变动'
#         verbose_name_plural =verbose_name
#         proxy = True
#
#
#     def set_normal_init_leftmoney(self,**kwargs):
#         reportmonth = self.reportmonth
#
#         return Cardinfo.objects.filter(flag='Y',company=self.company, status='O',cardtype=self.cardtype).values('storecode').annotate(sumleftmoney=Sum('leftmoney'))


class CardBalanceReportQuery(models.Model):
    """Admin 报表入口（无实体表）。"""
