...
from .common_report import amount_bydate, get_carddata
...
urlpatterns=[
    ...
    url(r'get_carddata/', get_carddata),


    url(r'^get_base_data/', views.get_base_data),
    url(r'^get_coredata_bystore/?', views.get_coredata_bystore),
    url(r'^get_store_dimension_sales/?', views.get_store_dimension_sales, name='get_store_dimension_sales'),
