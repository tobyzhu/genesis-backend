# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2020-05-05 15:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mall', '0002_remove_onlineshowitem_large_showimage'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='onlineshowtype',
            name='ttype',
            field=models.CharField(blank=True, choices=[('G', '商品'), ('S', '服务'), ('C', '售卡'), ('I', '充值')], max_length=16, null=True, verbose_name='分类'),
        ),
    ]
