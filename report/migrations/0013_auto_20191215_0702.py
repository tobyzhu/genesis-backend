# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2019-12-15 07:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('report', '0012_auto_20191214_2334'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportId', models.CharField(blank=True, max_length=128, null=True, verbose_name='报表编号')),
                ('reportName', models.CharField(blank=True, max_length=128, null=True, verbose_name='报表名称')),
            ],
            options={
                'verbose_name': 'Genesis报表',
                'db_table': 'report',
                'verbose_name_plural': 'Genesis报表',
                'managed': True,
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_item_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='报表项次')),
                ('report_item_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='项次名称')),
                ('report_item_type', models.CharField(blank=True, choices=[('交易', '交易数据'), ('公式', '公式'), ('其他', '其他')], max_length=16, null=True, verbose_name='项次类型')),
                ('report_item_rulers', models.CharField(blank=True, max_length=256, null=True, verbose_name='取值规则')),
                ('report_item_group', models.CharField(blank=True, max_length=128, null=True, verbose_name='项次分组')),
                ('report_item_order', models.CharField(blank=True, max_length=8, null=True, verbose_name='排序')),
                ('report_item_visible', models.CharField(blank=True, max_length=8, null=True, verbose_name='是否显示')),
                ('report_item_decimal_place', models.IntegerField(default=2, verbose_name='小数点位数')),
                # ('report_uuid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='report.Report', verbose_name='报表')),
            ],
            options={
                'verbose_name': '报表项次',
                'db_table': 'report_item',
                'verbose_name_plural': '报表项次',
                'managed': True,
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_item_qty', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=16, null=True, verbose_name='数量')),
                ('report_item_amount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=16, null=True, verbose_name='金额')),
                ('report_item_uuid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='report.ReportItem', verbose_name='报表项次')),
            ],
        ),
        migrations.RemoveField(
            model_name='classreportdata',
            name='storeuuid',
        ),
